...
<head>
    ...
    <title>Nabila & Zulfi Wedding Revision</title>
...
<body class="relative h-screen overflow-hidden">
    ...
    <div id="main-content" class="hidden">
        @include('pages-2.opening')

        @include('pages-2.couple')

        @include('pages-2.date')

        @include('pages-2.quotes')

        @include('pages-2.barcode')

        @include('pages-2.gallery')

        @include('pages-2.wedding-gift')

        @include('pages-2.navbar')
    </div>

    <script src="{{asset('assets_new/js/main-2.js')}}"></script>

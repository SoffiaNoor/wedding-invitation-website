<section id="opening"
    ...
    <img src="{{ asset('assets_new/images/flower-1.png') }}" alt="flower"
    ...
    <img src="{{ asset('assets_new/images/flower-2.png') }}" alt="flower"
    ...
    <img src="{{ asset('assets_new/images/border-tr2.png') }}" alt=""
        class="absolute top-[20px] right-[20px] z-40 h-auto w-[30%] sm:w-[20%] md:w-[15%] lg:w-[10%]" />

    <img src="{{ asset('assets_new/images/border-tl.png') }}" alt=""
    ...
    <img src="{{ asset('assets_new/images/nz.png') }}" alt="NZ Logo"

<section id="date"
    ...
    <div class="relative z-20 w-full max-w-3xl space-y-4">
        ...
        <img src="{{ asset('assets_new/images/line-decor.png') }}" class="w-[60%] md:w-[15%] h-auto mx-auto my-1"
            alt="line" />
        ...
        <div class="space-y-1">
            ...
            <a href="https://maps.google.com/?q=Grand+Ballroom+City+Center" target="_blank" class="relative overflow-hidden group text-2xl font-brittany rounded-full 

<div id="wedding-gift" class="page-section h-screen w-screen flex flex-col items-center justify-center 
    ...
    <img class="wedding-gift-bride absolute lg:bottom-[-300px] md:bottom-[-200px] bottom-[-100px] lg:right-[-100px] right-[-50px] lg:w-[30%] md:w-[45%] w-[60%] h-auto z-10"
    ...
    <img class="wedding-gift-groom absolute lg:bottom-[-300px] md:bottom-[-200px] bottom-[-100px] lg:left-[-100px] left-[-50px] lg:w-[30%] md:w-[45%] w-[60%] h-auto z-10"
